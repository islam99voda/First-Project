...
class InvoicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //sotore atachment 
        if ($request->hasFile('pic')) { //picفيه صور اسمها  reqouestلو ال
            ...
            $attachments->save();
             // اسم المرفق احفظه في الجدول/والمرفق احفظه على السيرفر عندي في فولدر لوحده
    ...
    public function InvoicesDetails( $id)
    {
        ...
        $attachments = invoice_attachments::where('invoice_id',$id)->get();//هات كل المرفقات اللي تخص رقم الفاتورة اللي اتبعتلك
